...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketHolder.checked_in'
        db.add_column(u'shipmates_ticketholder', 'checked_in',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketHolder.checked_in'
        db.delete_column(u'shipmates_ticketholder', 'checked_in')
